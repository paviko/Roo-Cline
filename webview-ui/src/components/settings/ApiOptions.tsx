			...
			<>
				...
				<VSCodeTextField
					...
					onChange={(e) => {
						...
						setApiConfigurationField("requestsPerMinuteLimit", updatedRequestsPerMinuteLimit)
					}}
	...
	switch (provider) {
		case "manual":
			return {
				...
				selectedModelId: "",
				selectedModelInfo: { supportsPromptCache: false, supportsImages: false, contextWindow: 1_000_000, maxTokens: 1_000_000, inputPrice: 3.0, outputPrice: 15.0 },
			}
		case "anthropic":
